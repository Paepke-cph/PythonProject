...
class PolynomialReg:
    def __init__(self, dataset, make):
        ...
        self.X_year = self.dataset_year_new.iloc[:, 5:6]
        self.y_year = self.dataset_year_new.iloc[:, -1]
        ...
        self.X_km = self.dataset_km_new.iloc[:, 4:5]
        self.y_km = self.dataset_km_new.iloc[:, -1]
