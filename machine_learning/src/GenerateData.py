...
def makeCar():
    make = random.choice(['Alfa Romeo', 'BMW', 'Chevrolet', 'Dodge',
                          'Fiat', 'Honda', 'Jaguar', 'Kia', 'Mazda', 'Mercedes-Benz'])
    ...
    car = {'make': make, 'year': year, 'newprice': newprice, 'kmperliter': kmperliter, 'km': km,
           'horsepower': horsepower, 'gearbox': gearbox, 'fueltype': fueltype, 'doornumber': doornumber, 'price': price}
    return car


if __name__ == "__main__":
    fields = ['make', 'year', 'newprice', 'kmperliter', 'km',
              'horsepower', 'gearbox', 'fueltype', 'doornumber', 'price']
